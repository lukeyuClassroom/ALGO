<template>
  <div class="hidden">
    <vs-sidebar absolute v-model="activeMenu" open>
      <template #logo>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 401.69 98.4" class="logo-nav">
          <g id="Capa_2" data-name="Capa 2">
            <g id="Capa_1-2" data-name="Capa 1">
              <path d="M105.79,27.23h12.78l16.12,44.65L150.9,27.23h12.77L141.48,85.56h-13.4Z"></path>
              <path
              ...
              <polygon points="92.25 8.05 75.25 8.05 46.14 53.12 17.04 8.05 0.04 8.05 46.15 79.45 92.25 8.05"></polygon>
              <polygon points="46.15 87.39 7.11 26.94 0 26.94 46.14 98.4 92.29 26.94 85.18 26.94 46.15 87.39"></polygon>
              <polygon points="70.34 1.37 46.14 38.17 21.95 1.37 39.75 5.87 39.75 0 52.54 0 52.54 5.87 70.34 1.37">
              </polygon>
            </g>
          </g>
        </svg>
      ...
      <template #footer>
        <vs-row justify="space-between">
          ...
          <vs-avatar v-if="notificationNumber > 0" badge-color="warning" badge-position="top-right"
            @click="notificationNumber--">
